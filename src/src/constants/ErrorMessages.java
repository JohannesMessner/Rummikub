...
public class ErrorMessages {
  ...
  public static final String NOT_ENOUGH_POINTS_ERROR = "You need to put down stones at least " + GlobalConstants.getMinFirstMovePoints() + " worth of points to go on";
}
